...
arabic_stop_words = {
    'في', 'من', 'على', 'و', 'ب', 'إلى', 'عن', 'أن', 'إن', 'كان', 'ما', 'هذه', 'هذا', 'ذلك', 'كل', 'أي', 'أو', 'لكن', 'كما', 'لقد', 'الذي', 'التي', 'اللذان', 'اللتان', 'الذين', 'اللواتي', 'اللاتي', 'الذي', 'الذين', 'اللذان', 'اللتان'
}
...
if __name__ == "__main__":
    # Simulate user input
    user_input = "sabat  sport mayfoutech 400 dinar  "
